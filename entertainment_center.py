...
the_departed = media.Movie("The Departed", "http://www.richardcrouse.ca//"
...
good_will_hunting = media.Movie("Good Will Hunting", "https://upload."
...
silicon_valley = media.Movie("Silicon Valley",
                             ...
                             "https://www.youtube.com/watch?v=69V__"
                             "a49xtw")
movies = [sent_of_a_women, the_departed, eight_mile,
          good_will_hunting, silicon_valley]
